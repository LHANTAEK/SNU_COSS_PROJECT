...
이 프로젝트는 대학 강의 계획서 파일을 기반으로 학생들이 할 만한 질문과 그에 대한 답변을 자동으로 생성하는 시스템입니다. '한국교육학술정보원_대학학과커리큘럼_강의계획서'를 토대로 RLHF를 위한 정확하고 다양한 Q&A를 자동으로 생성하여 사람의 피드백을 최소화 할 수 있게 하는 것이 주된 목표였습니다.
### 결과물
