# "LangGraph를 활용한 대학 강의 Q&A 데이터셋 생성 AI 에이전트"

## 📚 프로젝트 소개

이 프로젝트는 '한국교육학술정보원 대학학과커리큘럼 강의계획서'를 기반으로 다양한 학생들이 가질 수 있는 질문과 그에 대한 답변을 자동으로 생성하고 데이터셋으로 만들기 위해 진행됐습니다. 강의계획서를 토대로 RLHF를 위한 정확하고 다양한 Q&A를 자동으로 생성하여 사람의 피드백을 최소화 할 수 있게 하는 것이 주된 목표였습니다.
